...
#define do_op2(Name, arg) make_PreOp(prev,Name(trans_op_arg(arg)))(arg)
#define do_op3(Name, arg1,arg2) make_PreOp(prev,Name(trans_op_arg(arg1),trans_op_arg(arg2)))(arg1,arg2)
