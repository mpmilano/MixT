...
public:
  LocalSQLConnection(
      ...
      : LocalSQLConnection_super(unused_connections) {
    ...
    if (l == Level::strong) {
      ...
      tr->exec_async(noop, "SET SESSION CHARACTERISTICS AS TRANSACTION "
...
void LocalSQLConnection_super::prepare(const std::string &name,
