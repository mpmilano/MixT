...
pgtransaction::pgtransaction(LocalSQLConnection_super &conn,
                             const std::size_t tid)
    : transaction_id(tid), conn(conn),
      my_trans(
          (conn.transactions.emplace_back(*this), &conn.transactions.back())) {
#ifndef NDEBUG
...
bool pgtransaction::no_future_actions() const { return no_fut_actions; }
