...
#define free_expr2(T,e) ([&](){ struct Force_cexpr{static constexpr bool fun() {discard(e); return true;} }; \
								...
								return FreeExpr<T>(active_tracker, [&](){return e;});}())
...
#define free_expr3(T,a,e) ([&](){ using t = typename extract_type<decltype(a)>::type; struct Force_cexpr{static constexpr bool fun(const t &a) {discard(e); return true;} }; \
								  if (false) assert(Force_cexpr::fun(*mke_p<t>())); \
								  return FreeExpr<T,decltype(a)>(active_tracker, [&](const t &a){return e;}, a);}())
...
#define free_expr4(T,a,b,e) ([&](){ using ta = typename extract_type<decltype(a)>::type; \
									...
									return FreeExpr<T,decltype(a),decltype(b)>(active_tracker, [&](const ta &a, const tb &b){return e;},a,b)}())
...
#define $2(a,b) free_expr(decltype(std::declval<run_result<decltype(a)> >().get(active_tracker,nullptr).b), a, a.b)

#define $1(a) free_expr(decltype(std::declval<run_result<decltype(a)> >().get(active_tracker,nullptr)), a,a)
...
#define msg(a,b,c...) free_expr(decltype(std::declval<run_result<decltype(a)> >().get(active_tracker,nullptr).b(on_each_prn(std::declval<run_result<decltype, c, > >()))), a, c, a.b(c))
